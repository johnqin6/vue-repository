<template>
  <div class="slide-verify" id="slideVerify" onselelectstart="return false">
    ...
    <div class="slide-verify-slider"
      ...
      <!-- slider -->
      <div class="slide-verify-slider-mask-item"
      ...
      <span class="slide-verify-verify-slider-text">{{ sliderText }}</span>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    draw (ctx, x, y, operation) {
      ...
      ctx.stokeStyle = 'rgba(255, 255, 255, 0.7)'
      ctx.stroke()
      ctx[operation]()
